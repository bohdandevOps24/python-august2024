...
INSTANCE_IDS = ['i-0b3e1aa29f740668e', 'i-0366aa86724283b0a']  # Replace with your actual EC2 instance IDs
...
schedule.every().day.at("03:07").do(start_instances)  # Schedules start at 8:00 AM
schedule.every().day.at("03:06").do(stop_instances)   # Schedules stop at 6:00 PM
